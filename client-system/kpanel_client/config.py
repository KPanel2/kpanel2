...
class ClientConfig:
    ...
    wifi_enabled: bool = _env_bool("KPANEL_WIFI_ENABLED", "false")
    wifi_ui_enabled: bool = _env_bool("KPANEL_WIFI_UI_ENABLED", "false")
    ...
    hotspot_fallback_enabled: bool = _env_bool("KPANEL_HOTSPOT_FALLBACK_ENABLED", "false")
